...
let output = '| Tier | Duration | Key 1 | Key 2 | Key 3 |\n';
output += '|---|---|---|---|---|\n';
...
tiers.forEach(tier => {
    durations.forEach(duration => {
        ...
        output += `| ${tier.toUpperCase()} | ${duration} | ${k1} | ${k2} | ${k3} |\n`;
    });
});

fs.writeFileSync('keys_utf8.txt', output, 'utf8');
console.log('Keys written to keys_utf8.txt');
